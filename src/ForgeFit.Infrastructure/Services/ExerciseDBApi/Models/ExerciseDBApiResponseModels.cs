...
internal record ExerciseDbItem(
    ...
    [property: JsonPropertyName("targetMuscles")] List<string> TargetMuscles,
    [property: JsonPropertyName("bodyParts")] List<string> BodyParts,
    [property: JsonPropertyName("equipments")] List<string> Equipments,
    [property: JsonPropertyName("secondaryMuscles")] List<string> SecondaryMuscles,
