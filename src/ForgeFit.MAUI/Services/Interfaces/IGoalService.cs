...
public interface IGoalService
{
    ...
    // create body goal
    Task<ServiceResponse<BodyGoalResponse?>> CreateBodyGoal(BodyGoalCreateRequest goal,
        CancellationToken cancellationToken = default);

    Task<ServiceResponse<BodyGoalResponse?>> UpdateBodyGoal(BodyGoalCreateRequest goal,
        CancellationToken cancellationToken = default);

    Task<ServiceResponse<NutritionGoalResponse?>> UpdateNutritionGoal(NutritionGoalCreateRequest goal,
        CancellationToken cancellationToken = default);

    Task<ServiceResponse<WorkoutGoalResponse?>> UpdateWorkoutGoal(WorkoutGoalCreateRequest goal,
        CancellationToken cancellationToken = default);
}
