...
{
    Task<ServiceResponse<List<DrinkEntryResponse>>> GetEntriesByDateAsync(DateTime date, CancellationToken cancellationToken = default);
    Task<ServiceResponse<List<DrinkEntryResponse>>> GetEntriesByDateRangeAsync(DateTime from, DateTime to, CancellationToken cancellationToken = default);
    Task<ServiceResponse<DrinkEntryResponse?>> GetEntryAsync(Guid entryId, CancellationToken cancellationToken = default);
