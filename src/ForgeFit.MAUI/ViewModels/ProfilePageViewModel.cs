...
using ForgeFit.MAUI.ViewModels.Profile;
...
public partial class ProfilePageViewModel : BaseViewModel
{
        ...
        ILocalizationResourceManager localizationManager)
    {
        ...
        BodyGoalVM = new BodyGoalViewModel(goalService, bmiService, goalRealismValidator, alertService, localizationManager);
    ...
    {
        ConfirmationVM.ShowConfirmation("Confirm_UpdatePlan_Title", "Confirm_UpdatePlan_Message", ExecuteUpdatePlanAsync);
    }
